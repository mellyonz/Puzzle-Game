...
Working with Unity
The Scene and code division adds a very interesting problem especially for a puzzle game that needs dynamic generation. That problem is I don’t need the scene at all, the only potential us is for something like backgrounds or UI.
...
Pushed to the extreme one asset could serve the entire program’s needs, like let’s say like moving grass.
(Unity, 2019)
 
MoSCoW
